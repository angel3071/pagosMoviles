...
public class FragmentPrueba extends Fragment {
     ...
     * @return a new page
     */
    public static FragmentPrueba newInstance(int color, int index) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_prueba, container, false);
 
        // Show the current page index in the view
        TextView tvIndex = (TextView) rootView.findViewById(R.id.textView1);
